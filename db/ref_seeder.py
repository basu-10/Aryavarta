...
_TROOPS: dict[str, dict] = {
    ...
    "Troll": {
        ...
        "notes": "Star-1 monster melee unit. Spawns in star-1 forts and camps.",
    },
    "Wraith": {
        "category":          "monster",
        ...
        "notes": "Star-1 monster ranged unit. Spawns in star-1 forts and camps.",
    },
    "Goblin Brute": {
        "category":          "monster",
        "base_hp":           450, "base_damage": 55, "base_defense": 35,
        "base_range":        1,   "speed": 1.0,
        "attack_speed":      0.95,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Savage vanguard that swarms intruders with cleaver strikes.",
        "notes": "Star-2 monster melee unit. Spawns in star-2 forts and camps.",
    },
    "Harpy": {
        "category":          "monster",
        "base_hp":           220, "base_damage": 70, "base_defense": 10,
        "base_range":        3,   "speed": 1.0,
        "attack_speed":      1.05,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Winged raider that dives repeatedly from mid-range.",
        "notes": "Star-2 monster ranged unit. Spawns in star-2 forts and camps.",
    },
    "Minotaur": {
        "category":          "monster",
        "base_hp":           900, "base_damage": 95, "base_defense": 70,
        "base_range":        1,   "speed": 1.0,
        "attack_speed":      0.9,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Labyrinth warlord that crushes frontlines with horned charges.",
        "notes": "Star-3 monster melee unit. Spawns in star-3 forts and camps.",
    },
    "Basilisk": {
        "category":          "monster",
        "base_hp":           450, "base_damage": 120, "base_defense": 30,
        "base_range":        3,   "speed": 0.9,
        "attack_speed":      1.0,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Petrifying serpent that punishes overextended lines from afar.",
        "notes": "Star-3 monster ranged unit. Spawns in star-3 forts and camps.",
    },
    "Gargoyle": {
        "category":          "monster",
        "base_hp":           1_800, "base_damage": 170, "base_defense": 130,
        "base_range":        1,   "speed": 0.9,
        "attack_speed":      0.85,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Living obsidian sentinel that shrugs off ordinary weapons.",
        "notes": "Star-4 monster melee unit. Spawns in star-4 forts and camps.",
    },
    "Manticore": {
        "category":          "monster",
        "base_hp":           900, "base_damage": 210, "base_defense": 55,
        "base_range":        3,   "speed": 0.9,
        "attack_speed":      0.95,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Barbed apex hunter whose tail volleys shred dense formations.",
        "notes": "Star-4 monster ranged unit. Spawns in star-4 forts and camps.",
    },
    "Hydra": {
        "category":          "monster",
        "base_hp":           3_600, "base_damage": 300, "base_defense": 240,
        "base_range":        1,   "speed": 0.9,
        "attack_speed":      0.8,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Regenerative behemoth that grinds armies down in prolonged clashes.",
        "notes": "Star-5 monster melee unit. Spawns in star-5 forts and camps.",
    },
    "Siren": {
        "category":          "monster",
        "base_hp":           1_700, "base_damage": 360, "base_defense": 100,
        "base_range":        3,   "speed": 0.8,
        "attack_speed":      0.9,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Sea witch whose resonance blasts break disciplined ranks.",
        "notes": "Star-5 monster ranged unit. Spawns in star-5 forts and camps.",
    },
    "Behemoth": {
        "category":          "monster",
        "base_hp":           8_000, "base_damage": 520, "base_defense": 420,
        "base_range":        1,   "speed": 0.8,
        "attack_speed":      0.78,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Mountain-sized juggernaut that anchors star-6 garrisons.",
        "notes": "Star-6 monster melee unit. Spawns in star-6 forts and camps.",
    },
    "Chimera": {
        "category":          "monster",
        "base_hp":           3_600, "base_damage": 650, "base_defense": 180,
        "base_range":        4,   "speed": 0.8,
        "attack_speed":      0.88,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Tri-headed abomination that projects lethal fire at long range.",
        "notes": "Star-6 monster ranged unit. Spawns in star-6 forts and camps.",
    },
    "Leviathan": {
        "category":          "monster",
        "base_hp":           20_000, "base_damage": 1_200, "base_defense": 900,
        "base_range":        1,   "speed": 0.8,
        "attack_speed":      0.75,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Abyss-born titan whose mass alone can halt a siege.",
        "notes": "Star-7 monster melee unit. Spawns in star-7 forts and camps.",
    },
    "Phoenix": {
        "category":          "monster",
        "base_hp":           10_000, "base_damage": 1_700, "base_defense": 320,
        "base_range":        4,   "speed": 0.7,
        "attack_speed":      0.85,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Solar predator that scorches lanes with reborn fury.",
        "notes": "Star-7 monster ranged unit. Spawns in star-7 forts and camps.",
    },
    "Colossus": {
        "category":          "monster",
        "base_hp":           120_000, "base_damage": 8_000, "base_defense": 6_000,
        "base_range":        1,   "speed": 0.7,
        "attack_speed":      0.72,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Runic giant forged for annihilation at the fortress gates.",
        "notes": "Star-8 monster melee unit. Spawns in star-8 forts and camps.",
    },
    "Thunderbird": {
        "category":          "monster",
        "base_hp":           70_000, "base_damage": 11_000, "base_defense": 2_200,
        "base_range":        4,   "speed": 0.7,
        "attack_speed":      0.82,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Tempest avatar that chains lightning through exposed wings.",
        "notes": "Star-8 monster ranged unit. Spawns in star-8 forts and camps.",
    },
    "Abyssal Titan": {
        "category":          "monster",
        "base_hp":           8_000_000, "base_damage": 300_000, "base_defense": 180_000,
        "base_range":        1,   "speed": 0.7,
        "attack_speed":      0.7,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Void-forged executioner that erases frontlines with singular blows.",
        "notes": "Star-9 monster melee unit. Spawns in star-9 forts and camps.",
    },
    "Void Drake": {
        "category":          "monster",
        "base_hp":           5_000_000, "base_damage": 420_000, "base_defense": 90_000,
        "base_range":        4,   "speed": 0.6,
        "attack_speed":      0.8,
        "base_costs":        {"gold": 0, "food": 0, "timber": 0, "metal": 0},
        "base_training_time": 0,
        "lore": "Rift-breath dragon that bombards defenders from extreme range.",
        "notes": "Star-9 monster ranged unit. Spawns in star-9 forts and camps.",
    },
    "Longbowman": {
        "category":          "ranged",
        "base_hp":           60,  "base_damage": 20, "base_defense": 0,
    ...
    # Apex pair for star-level 10 camps and forts.
    "Demon": {
        "category":          "monster",
        ...
        "notes": "Star-10 monster melee unit. Spawns in star-10 forts and camps.",
    },
    "Pegasus": {
        "category":          "monster",
        ...
        "notes": "Star-10 monster ranged unit. Spawns in star-10 forts and camps.",
    },
}
